...
namespace QrCafe.Api.Mappers
{
    public static class OrdersMapper
    {
        ...
        public static OrderPublicDto ToDto(GetOrderByIdResult r) => new(
            r.OrderId, r.OrderType, r.TableNumber, r.TableToken, r.CustomerName, r.DeliveryAddress, r.DeliveryReference, r.DeliveryPhone, r.Status, r.PaymentStatus, r.PaymentMethod, r.Currency,
